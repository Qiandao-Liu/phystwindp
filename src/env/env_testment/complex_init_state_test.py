# /workspace/src/env/env_testment/complex_init_state_test.py
import sys, os
import torch
import numpy as np
...
def main():
    ...
    # ✅ 替换成加载自定义初始状态
    init_state_path = "./PhysTwin/mpc_init/init_000.pkl"
    print(init_state_path)
    ...
    ctrl_delta_traj_2[:, 0, 1] = 0.01 * np.sin(theta)
    ctrl_delta_traj_2[:, 1, 2] = -0.01 * np.cos(theta)
